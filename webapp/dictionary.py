...
class Dictionary:
    ...
    def serve(cls, req):
        ...
        div = jp.Div(a=wp, classes="br-gray-200 h-screen")
        ...
        # jp.Button(a=input_div, text="Get Definition", classes="border-2 text-white rounded bg-gray-500", click=cls.get_definition, outputdiv=output_div, inputbox=input_box)
